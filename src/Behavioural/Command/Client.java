...
//Behavioural.Command declares an interface for all commands, providing a simple execute() method which asks the Receiver of
...
//Invoker
// The Invoker holds a command(has-A) and can get the Behavioural.Command to execute a request by calling the execute method.
...
public class Client{
    public static void main(String[] args)    {
        ...
        // The Invoker holds a command and can get the Behavioural.Command to execute a request by calling the execute method
        control.pressButton();
        //switch off
