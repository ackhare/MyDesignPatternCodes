...
//Below is done to give a specfic structure and remove error
        ...
        // They could be provided in the same package as the Structural.Facade for example.
    ...
    class TravelFacade {
        ...
        public void getFlightsAndHotels(Date from, Date to) {
           ...
           // All that the client needs to worry about is the Structural.Facade class:
           class Client {
